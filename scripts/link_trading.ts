...
async function main(): Promise<void> {
	...
	console.log('=== TRADING ACCOUNT - Initiating Link ===\n');
	...
	const wallet = new ethers.Wallet(tradingKey);
	const finalNonce = nonceArg ? BigInt(nonceArg) : BigInt(Date.now());

	console.log(`Signing with trading account: ${wallet.address}`);
	console.log(`Linking to staking account: ${stakingAddress}`);
